...
Currently one can run the project with `dart run` in the terminal. This starts the Game of life which you can stop by pressing `q`.

## The obligatory screenshot

![Screenshot of my running Game of Life](https://raw.githubusercontent.com/centaurus22/screenshots/refs/heads/main/game-of-life-dart.png)
...
This game has been tested on Linux and works with the terminal emulators Alacritty and GNOME Terminal.
