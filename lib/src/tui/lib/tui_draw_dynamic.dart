...
/// A command which draws the dynamic elements of the terminal unser interface
class TuiDrawDynamic {
  /// Execute the command: Draw the dynamic elements of the terminal unser interface
  ///
